...
class _HomeScreenState extends State<HomeScreen> {
  ...
  List<Amazon> amazon_data = [];
  List<CashBack> top_cashback = [];
  List<TopOffer> top_Categories = [];
  ...
  Future<void> get_list() async {
    ...
    print(top_Categories[0].image_url);
  ...
  void temp(bool cancel) {
    addNew = cancel;
    edit = cancel;
    setState(() {});
    if (selected_popup == 1) {
      top_Categories.clear();
    } else if (selected_popup == 2) {
      top_cashback.clear();
    } else {
      amazon_data.clear();
    }
  ...
  Amazon? output_Data_Amazon;
  TopOffer? output_Data_Topoffer;
  CashBack? output_Data_CashBack;
  @override
  Widget build(BuildContext context) {
    ...
    return SafeArea(
      ...
      body: LoadingOverlay(
        ...
        isLoading: addNew,
        progressIndicator: selected_popup == 1
            ? AddCategories(
                onCancelPressed: (bool cancel) => {temp(cancel)},
                input_Data: output_Data_Topoffer,
                index: selected_index,
                edit: edit)
            : selected_popup == 2
                ? add_cashback(
                    onCancelPressed: (bool cancel) => {temp(cancel)},
                    input_Data: output_Data_CashBack,
                    edit: edit,
                    index: selected_index,
                  )
                : AddAmazon(
                    onCancelPressed: (bool cancel) => {temp(cancel)},
                    input_Data: output_Data_Amazon,
                    edit: edit,
                    index: selected_index,
                  ),
                            ...
                            items: [
                              slider_widget(
                                image_url: slider_data.isEmpty
                                    ? ""
                                    : slider_data[0].image_url ?? "",
                              ),
                              slider_widget(
                                image_url: slider_data.isEmpty
                                    ? ""
                                    : slider_data[1].image_url ?? "",
                              ),
                              slider_widget(
                                image_url: slider_data.isEmpty
                                    ? ""
                                    : slider_data[2].image_url ?? "",
                              ),
                              slider_widget(
                                image_url: slider_data.isEmpty
                                    ? ""
                                    : slider_data[3].image_url ?? "",
                              ),
                              slider_widget(
                                image_url: slider_data.isEmpty
                                    ? ""
                                    : slider_data[4].image_url ?? "",
                              ),
                            ],
                        ...
                        children: [
                            ...
                            children: [
                              ...
                              InkWell(
                                onTap: () {
                                  addNew = true;
                                  edit = false;
                                  output_Data_Topoffer = TopOffer(
                                      link: "", image_url: "", title: "");
                                  selected_popup = 1;
                                  setState(() {});
                                },
                                child: Container(
                          ...
                          Container(
                            ...
                            child: ListView.builder(
                                ...
                                // itemCount: 10,
                                itemCount: top_Categories.length,
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(
                                    onTap: () async {
                                      print("pressed");
                                      output_Data_Topoffer = TopOffer(
                                        link: top_Categories[index].link,
                                        image_url:
                                            top_Categories[index].image_url,
                                        title: top_Categories[index].title,
                                      );
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(
                                    onTap: () async {
                                      ...
                                      edit = true;
                                      output_Data_CashBack = CashBack(
                                          cashback_percent: top_cashback[index]
                                              .cashback_percent,
                                          date: top_cashback[index].date,
                                          image_url:
                                              top_cashback[index].image_url,
                                          offer_percent:
                                              top_cashback[index].offer_percent,
                                          link: top_cashback[index].link);
                                      selected_popup = 2;
                                      await FirebaseFirestore.instance
                                          .collection('top_cashback')
                                          .get()
                                ...
                                itemBuilder: (BuildContext context, int index) {
                                  return InkWell(
                                    onTap: () async {
                                      ...
                                      addNew = true;
                                      edit = true;
                                      output_Data_Amazon = Amazon(
                                          link: amazon_data[index].link,
                                          image_url:
